# Autogenerated wrapper script for EDFlib_jll for x86_64-apple-darwin14
export libedflib
...
const libedflib_splitpath = ["lib", "libedflib.dylib"]
...
const libedflib = "@rpath/libedflib.dylib"
