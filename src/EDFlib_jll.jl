...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import EDFlib_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("b51820a9-a924-5fc2-b09e-5fb7870ce458"))
platforms = [Pkg.Artifacts.unpack_platform(e, "EDFlib", artifacts_toml) for e in artifacts["EDFlib"]]
...
if best_platform === nothing
    @debug("Unable to load EDFlib; unsupported platform $(triplet(platform_key_abi()))")
else
